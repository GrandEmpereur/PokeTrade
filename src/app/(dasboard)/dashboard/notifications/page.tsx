              ...
              <div className="flex flex-col gap-2 px-4 lg:flex-row lg:items-center lg:justify-between lg:px-6">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Consultez et gérez vos alertes et notifications concernant
                    votre collection et le marché.
                  </p>
                </div>
                ...
                <div className="divide-y">
                  ...
                  <div className="flex items-start gap-4 py-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        ...
                        baissé de prix de <strong>15%</strong>. Le nouveau prix
                        est de <strong>155 €</strong>.
                      </p>
                  ...
                  <div className="flex items-start gap-4 py-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Bénéficiez de <strong>-20%</strong> sur toutes les
                        cartes de la nouvelle extension{' '}
                        <strong>Scarlet & Violet - Astral Radiance</strong>{' '}
                        jusqu'au 15 juin.
                      </p>
                      <div className="mt-2">
                        <Button size="sm" variant="default">
                  ...
                  <div className="flex items-start gap-4 py-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Le tournoi{' '}
                        <strong>Pokémon Trading Card Game Online</strong>{' '}
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Recevez des notifications lorsque le prix d'une
                            carte de votre wishlist change
                          </p>
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            Recevez un résumé hebdomadaire de l'évolution de
                            votre collection
                          </p>
                        </div>
                        <Switch />
