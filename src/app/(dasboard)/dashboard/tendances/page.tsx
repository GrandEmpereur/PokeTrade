        ...
        <div className="flex flex-col gap-4 py-4 md:gap-6 md:py-6">
          <div className="px-4 lg:px-6">
            ...
            <p className="text-muted-foreground">
              Suivez les tendances du marché des cartes Pokémon, découvrez les
              cartes les plus populaires et anticipez les évolutions de prix.
            </p>
          </div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <p className="font-medium">Lugia VSTAR Rainbow</p>
                              <p className="text-xs text-muted-foreground">
                                Secret Rare
                              </p>
                            </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <p className="font-medium">Artikodin V Alt Art</p>
                              <p className="text-xs text-muted-foreground">
                                Ultra Rare
                              </p>
                            </div>
